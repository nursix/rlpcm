...
#
# RLPCM Template Version 1.0.0 => 1.0.1
#
# Execute in web2py folder after code upgrade like:
# python web2py.py -S eden -M -R applications/eden/modules/templates/BRCMS/RLP/upgrade/1.0.0-1.0.1.py
#
import sys
